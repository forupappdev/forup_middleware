            ...
            if aPair.JsonString.Value.Contains('timestamp') then
              begin
                ...
                AMongoDocument.Add(aPair.JsonString.Value,
                  FormatDateTime('yyyy-mm-dd HH:mm:ss', FloatToDateTime(aExtValue)));
              end
            else
              begin
                aExtValue := aValue.GetValue<Extended>;
