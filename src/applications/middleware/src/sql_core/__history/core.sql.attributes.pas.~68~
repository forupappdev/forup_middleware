...
type
  ...
  public
    ...
    constructor Create(aColumnName: string; aFieldType: TDBtype; aSize: Integer; aDescription: string  = EMPTYSTRING; 
      aExtraActions : TExtraActions = []; aRestrictions : TRestrictions = []); overload;
    constructor Create(aColumnName: string; aFieldType: TDBtype; aPrecision, aScale: Integer; aDescription: string  = EMPTYSTRING; 
      aExtraActions : TExtraActions = []; aRestrictions : TRestrictions = []); overload;
  published
    ...
    property Description: string read FDescription;
    property ExtraActions: TExtraActions read FExtraActions;
  ...
  private
    ...
    FTableName: string;
    FSchemaName: string;
    FDefaultSort: TSortingOrder;
  public
    constructor Create; overload;
    constructor Create(aName, aTableName, aColumnName : string; aDefaultSort : TSortingOrder = NoSort;
      aSchemaName : string = EMPTYSTRING); overload;
  published
    property Name: string read FName;
    property SchemaName: string read FSchemaName;
    property TableName: string read FTableName;
    property ColumnName: string read FColumnName;
    property DefaultSort: TSortingOrder read FDefaultSort;
  end;
...
constructor Column.Create(aColumnName: string; aFieldType: TDBtype;
  aSize: Integer; aDescription: string; aExtraActions: TExtraActions; aRestrictions : TRestrictions);
begin
  inherited Create;
  Self.FColumnName := aColumnName;
  Self.FFieldType := aFieldType;
  ...
  Self.FRestrictions := aRestrictions;
end;

constructor Column.Create(aColumnName: string; aFieldType: TDBtype; aPrecision,
  aScale: Integer; aDescription: string; aExtraActions: TExtraActions; aRestrictions : TRestrictions);
begin
  inherited Create;
  Self.FColumnName := aColumnName;
  Self.FFieldType := aFieldType;
...
constructor Index.Create;
begin
  Self.FName := EmptyStr;
  Self.FColumnName := EmptyStr;
  Self.FTableName := EmptyStr;
  Self.FSchemaName := EmptyStr;
  Self.FDefaultSort := NoSort;
end;

constructor Index.Create(aName, aTableName, aColumnName: string;
  aDefaultSort: TSortingOrder; aSchemaName: string);
begin
  inherited Create;
  ...
  Self.FSchemaName := aSchemaName;
  Self.FDefaultSort := aDefaultSort;
end;
